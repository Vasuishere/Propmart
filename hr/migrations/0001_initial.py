    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_title', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='hr.jobtitle')),
                ('work_location', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='hr.worklocation')),
            ],
        ),
    ]
